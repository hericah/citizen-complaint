...
<template>
  ...
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
          ...
          <nav class="hidden md:flex items-center space-x-6">
            ...
            <Link href="#laporan-publik" class="text-gray-700 hover:text-blue-600 transition font-medium">
              Laporan Publik
            </Link>
        ...
        <div v-show="mobileMenuOpen" class="md:hidden pb-4 space-y-2">
          <Link href="/" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">
            Home
          </Link>
          <Link href="#laporan-publik" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">
            Laporan Publik
          </Link>
          <Link href="/login" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">
            Login
          </Link>
        </div>
      </div>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
      <!-- Hero Carousel -->
      <section v-if="heroImages.length > 0" class="relative bg-white rounded-2xl shadow-lg overflow-hidden">
      ...
      <section id="laporan-publik">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          ...
          >
            ...
            <div class="relative h-48 bg-gray-200">
              ...
              <div class="absolute top-2 left-2">
                <span 
                  ...
                  :class="{
                    'bg-green-500': report.status === 'Selesai',
                    'bg-blue-500': report.status === 'Proses',
                    'bg-pink-500': report.status === 'Verifikasi',
                    'bg-orange-500': report.status === 'Diajukan'
                  }"
                >
                  {{ report.status }}
                </span>
            ...
            <!-- Report Info -->
            <div class="p-4">
              <h3 class="font-semibold text-gray-900 mb-2 line-clamp-2">{{ report.title }}</h3>
