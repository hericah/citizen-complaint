    ...
    <StaffLayout :user="user">
      <div class="mb-8">
        <div class="flex items-start justify-between">
          <div>
            <h2 class="text-2xl md:text-3xl font-bold text-gray-800">Edit Kategori Aduan</h2>
            <p class="text-sm text-gray-500 mt-1">Perbarui data kategori aduan</p>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 max-w-2xl">
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div>
            ...
            <input v-model="form.nama_kategori" type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400" :class="{ 'border-red-500': form.errors.nama_kategori }" />
...
const submit = () => {
  form.put(`/master/kategori/${props.kategori.id}`)
}
</script>
