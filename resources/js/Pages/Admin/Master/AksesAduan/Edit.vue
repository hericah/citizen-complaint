    ...
    <StaffLayout :user="user">
      <div class="mb-8">
        <div class="flex items-start justify-between">
          <div>
            <h2 class="text-2xl md:text-3xl font-bold text-gray-800">Edit Akses Aduan</h2>
            <p class="text-sm text-gray-500 mt-1">Perbarui data akses aduan</p>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-lg p-8 max-w-2xl">
        <form @submit.prevent="submit" class="space-y-6">
          ...
          <div>
            ...
            <input v-model="form.nama_akses_aduan" type="text" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400" :class="{ 'border-red-500': form.errors.nama_akses_aduan }" />
          ...
          <div>
            ...
            <textarea v-model="form.keterangan" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400" :class="{ 'border-red-500': form.errors.keterangan }"></textarea>
...
const form = useForm({
  nama_akses_aduan: props.aksesAduan.nama_akses_aduan,
  keterangan: props.aksesAduan.keterangan,
})

const submit = () => {
  form.put(`/master/aksesaduan/${props.aksesAduan.id}`)
}
</script>
